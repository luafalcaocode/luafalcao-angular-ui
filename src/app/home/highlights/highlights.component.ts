...
export class HighlightsComponent implements OnInit {
  ...
  constructor() {
    this.slides = [
      new SlideViewModel(`Design Patterns #6: Abstract Factory`, `Caindo na categoria de Padrões Criacionais o poderoso Abstract Factory é uma ferramenta muito útil para ajudar  na portabilidade.`, `highlight_1.png`, 1),
      new SlideViewModel(`Slide 2`, 'Conteúdo do Slide 2', 'highlight_2.png', 2),
      new SlideViewModel(`Slide 3`, 'Conteúdo do Slide 3', 'highlight_3.png', 3)
    ];
  ...
  changeSlide(id: number) {
    ...
    document.getElementById(id.toString()).classList.add('active-slide-navigation');
  }
}
